...
(function () {
  ...
  function routeRefresh() {
    ...
    if (isFactionPage()) { createLauncher(); createPanel(); }
  ...
  const observer=new MutationObserver(() => {
    if (location.href!==lastHref){lastHref=location.href; setTimeout(routeRefresh,250);} else if(isFactionPage()&&!isPaymentsRoute()&&!document.getElementById("rrh-launcher")) createLauncher();
  });
